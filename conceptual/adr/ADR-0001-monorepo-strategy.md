...
The QRbank platform consists of multiple services (backend API, OCR service,
...
The QRbank uses a single monorepo with clear directory boundaries between services,
